function lang_preview() {
  // let page_lang = localStorage.getItem("page_lang");
  let page_lang = "lang_arb";
  if (page_lang == null) {
    page_lang = "lang_arb";
  }

  let current_lang_id = $("#id_language").val();
  let current_lang_class = "lang_" + current_lang_id;
  let current_lang = $("#lang_div #" + current_lang_class).html();

  $("#current_lang").html(current_lang);
  $(".lang_arb_eng").css("display", "none");
  $("." + page_lang).css("display", "");
  $("#lang_div a").removeClass("active");
  $("#lang_div #" + current_lang_class).addClass("active");

  if (current_lang_id === "arb") {
    $(".lang_arb_dir").attr("dir", "rtl");
    $("body").addClass("rtl");
  } else {
    $(".lang_arb_dir").attr("dir", "ltr");
